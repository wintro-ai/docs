    ...
    head: [
      {
        ...
        innerHTML: `
          ...
          posthog.init('phc_ySFUFhFyyTmFmgwFC6IvTNJDPndQQ0587R3qnvlepxs',{api_host:'https://us.i.posthog.com', person_profiles: 'identified_only' // or 'always' to create profiles for anonymous users as well
          });
        `,
      },
    ],
